<?php
	// challenge "pixel madness" Root Me

	$tableau = array('0x3+1x1+0x1+0x1+0x7+1x2+0x15+1x1+0x8+1x1+0x8+1x1+0x1+1x1+0x1+1x1+0x1+1x1+0x1+1x1+0x3+1x1+0x1+1x1+0x3+1x1+0x1+1x4+0x2+1x1+0x25',
	...
	foreach($tableau as $ligne){
		...
		foreach($ligne as $colonne){
			$pixel = explode('x', $colonne);

			for($i = 0; $i < $pixel[1]; $i++){
				if($pixel[0] == 0){
					echo '<div style="display:inline-block;width:10px;height:10px;background-color:#FFFFFF;"></div>';
				} else {
					echo '<div style="display:inline-block;width:10px;height:10px;background-color:#000000;"></div>';
				}
			}
		}
